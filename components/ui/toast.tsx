  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-xl border p-4 pr-8 shadow-lg transition-all",
  {
    variants: {
      variant: {
        ...
        destructive: "border-electric-red/30 bg-electric-red/10 text-foreground",
        success: "border-electric-green/30 bg-electric-green/10 text-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "hover:bg-surface2 focus:outline-none focus:ring-1 focus:ring-accent",
